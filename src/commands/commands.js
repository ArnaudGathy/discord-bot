...
const localisations = [
  {min: 1, max: 1, value: 'Pied droit', effect: "-3 aux jets de parade et d'esquive + réduction de l'allure de 2m/round"},
  {min: 2, max: 2, value: 'Pied gauche', effect: "-3 aux jets de parade et d'esquive + réduction de l'allure de 2m/round"},
  {min: 3, max: 7, value: 'Tibia droit', effect: "Peut renverser en cas du succès critique"},
  {min: 8, max: 8, value: 'Genoux droit', effect: "Voir règles"},
  {min: 9, max: 9, value: 'Genoux gauche', effect: "Voir règles"},
  {min: 10, max: 14, value: 'Tibia gauche', effect: "Peut renverser en cas du succès critique"},
  {min: 15, max: 21, value: 'Cuisse droite', effect: "Peut renverser en cas du succès critique"},
  {min: 22, max: 22, value: 'Artère fémorale droite', effect: "ID x2 + DIF -3 sur toutes les actions + -1PV/round"},
  {min: 23, max: 29, value: 'Cuisse gauche', effect: "Peut renverser en cas du succès critique"},
  {min: 30, max: 30, value: 'Artère fémorale gauche', effect: "ID x2 + DIF -3 sur toutes les actions + -1PV/round"},
  {min: 31, max: 34, value: 'Bas ventre'},
  {min: 35, max: 35, value: 'Main droite', effect: "Désarme en cas de succès critique"},
  {min: 36, max: 36, value: 'Main gauche', effect: "Désarme en cas de succès critique"},
  {min: 37, max: 40, value: 'Avant bas droit', effect: "Fait perdre sa prochaine action à l'adversaire"},
  {min: 41, max: 44, value: 'Avant bas gauche', effect: "Fait perdre sa prochaine action à l'adversaire"},
  {min: 45, max: 46, value: 'Flanc droit'},
  {min: 47, max: 47, value: 'Foie', effect: "Adversaire tombe à genoux et subit DIFF -6 au lieu de -3"},
  ...
  {min: 68, max: 68, value: 'Coeur', effect: "ID x2 + DIF -3 sur toutes les actions + -1PV/round"},
  {min: 69, max: 81, value: 'Poitrine'},
  {min: 82, max: 84, value: 'Epaule droite'},
  {min: 85, max: 85, value: 'Aisselle droite', effect: "ID x2 + DIF -3 sur toutes les actions + -1PV/round"},
  {min: 86, max: 89, value: 'Epaule gauche'},
  {min: 89, max: 89, value: 'Aisselle gauche', effect: "ID x2 + DIF -3 sur toutes les actions + -1PV/round"},
  {min: 90, max: 90, value: 'Clavicule gauche', effect: "En cas de succès critique, la clavicule se brise empêchant l'adversaire d'utiliser son bras"},
  {min: 91, max: 92, value: 'Cou / nuque / gorge', effect: "ID x2 + DIF -3 sur toutes les actions + -1PV/round"},
  {min: 93, max: 93, value: 'Clavicule droite', effect: "En cas de succès critique, la clavicule se brise empêchant l'adversaire d'utiliser son bras"},
  {min: 94, max: 94, value: 'Bouche', effect: "ID augmenté de moitié, possibilité d'assomer"},
  {min: 95, max: 95, value: 'Nez', effect: "ID augmenté de moitié, possibilité d'assomer"},
  {min: 96, max: 96, value: 'Yeux', effect: "PER divisé par 2, ID et IC divisés par 2"},
  {min: 97, max: 97, value: 'Oreille droite', effect: "ID augmenté de moitié, possibilité d'assomer"},
  {min: 98, max: 98, value: 'Oreille gauche', effect: "ID augmenté de moitié, possibilité d'assomer"},
  {min: 99, max: 99, value: 'Sommet du crâne / front', effect: "ID augmenté de moitié, possibilité d'assomer"},
  {min: 100, max: 100, value: 'Entre les deux yeux'},
]

const getLocalisationMessage = (roll, author) => {
  const localisation = localisations.find((loc) => roll >= loc.min && roll <= loc.max)
  return `${author} : ${roll} - ${localisation.value}${localisation.effect ? ` (${localisation.effect})` : '' }`
}
